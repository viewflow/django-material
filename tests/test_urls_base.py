...
from material.urls import IndexViewMixin, Viewset, route
...
class InheritedViewset(NestedViewset):
    ...
    page_path = path(
        "page2/", TemplateView.as_view(template_name="material/base.html"), name="page"
    )
...
class RootViewset(Viewset):
    ...
    index_path = path("", TemplateView.as_view(template_name="material/base.html"), name="index")
