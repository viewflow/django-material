...
from tests.integration.tests.test_splitdatetime import Test as TestSplitDateTime
from . import VisualTest


class Test(VisualTest):
    urls = TestSplitDateTime.urls
    ...
    def test_render_with_value(self):
        self.driver.get('%s%s' % (self.live_server_url, TestSplitDateTime.test_render_with_value.url))
    ...
    def test_part_group_class(self):
        self.driver.get('%s%s' % (self.live_server_url, TestSplitDateTime.test_part_group_class.url))
        self.assertScreenshot('form', 'splitdatetime_part_group_class')

    def test_part_add_group_class(self):
        self.driver.get('%s%s' % (self.live_server_url, TestSplitDateTime.test_part_add_group_class.url))
        self.assertScreenshot('form', 'splitdatetime_part_add_group_class')

    def test_part_prefix(self):
        self.driver.get('%s%s' % (self.live_server_url, TestSplitDateTime.test_part_prefix.url))
        self.assertScreenshot('form', 'splitdatetime_part_prefix')

    def test_part_add_control_class(self):
        self.driver.get('%s%s' % (self.live_server_url, TestSplitDateTime.test_part_add_control_class.url))
        self.assertScreenshot('form', 'splitdatetime_part_add_control_class')

    def test_part_label(self):
        self.driver.get('%s%s' % (self.live_server_url, TestSplitDateTime.test_part_label.url))
        self.assertScreenshot('form', 'splitdatetime_part_label')

    def test_part_add_label_class(self):
        self.driver.get('%s%s' % (self.live_server_url, TestSplitDateTime.test_part_add_label_class.url))
        self.assertScreenshot('form', 'splitdatetime_part_add_label_class')

    def test_part_help_text(self):
        self.driver.get('%s%s' % (self.live_server_url, TestSplitDateTime.test_part_help_text.url))
        self.assertScreenshot('form', 'splitdatetime_part_help_text')

    def test_part_errors(self):
        self.driver.get('%s%s' % (self.live_server_url, TestSplitDateTime.test_part_errors.url))
