...
class SiteMiddleware:
    ...
    def process_template_response(
        ...
        try:
            ...
            # Only process if we have context data and it's a SimpleTemplateResponse
            if app_context and isinstance(response, SimpleTemplateResponse):
                # Initialize context_data if it's None
